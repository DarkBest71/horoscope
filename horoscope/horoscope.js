...
SCRIBE = SARAH.context.scribe; ScribeAskMe = SARAH.ScribeAskMe; ScribeSpeak = SARAH.ScribeSpeak; SCRIBE.activePlugin('horoscope');
phrasehoroscope=JSON.stringify(SARAH.context.scribe.lastReco);phrasehoroscope=JSON.parse(phrasehoroscope).toLowerCase()
...
console.log(signe); request = require('request'); cheerio = require('cheerio');
